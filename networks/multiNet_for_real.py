...
class multiNet_for_real(nn.Module):
    def __init__(self, channel_settings, output_shape):
        super(multiNet_for_real, self).__init__()
        ...
        self.predict_control_embedding = self._predict(num_class = 1)
        self.predict_end_embedding = self._predict(num_class = 1)
    ...
    def forward(self, x):
        ...
        return control_point_pred, end_point_pred, mask_pred, control_point_embeding, end_point_embeding